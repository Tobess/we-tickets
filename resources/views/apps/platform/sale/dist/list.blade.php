@extends('layouts.content', ['_title' => '分销商家'])

@section('content')
    <ul class="breadcrumb m-b-none">
        <li><span class="text-muted">产品</span></li>
        <li class="active"><span class="text-muted">分销商家</span></li>
    </ul>
    <div class="padder">
        <div class="panel panel-default">
            <div class="row wrapper">
                <div class="col-sm-6">
                    <a class="btn btn-sm btn-primary" type="button" href="{{ app_route('sale/distributor/edit/0') }}">
                ...
                <table class="table table-striped b-t b-light m-b-none">
                    ...
                    @foreach ($rows as $row)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-xs btn-info m-b-none" type="button" href="{{ app_route('sale/distributor/edit/' . $row->id) }}">编辑</a>
                                @if(!$row->deleted_at)
...
@section('scripts')
    <script type="text/javascript">
        ...
        {
            if (confirm('您确定要删吗?')) {
                window.location.href='{{ app_route('sale/distributor/stop/') }}' + id;
            }
        }
    </script>
@stop